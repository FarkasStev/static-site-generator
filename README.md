...
A static site generator written in Python. This project is designed to generate static websites from Markdown files. This personal project allowed me to learn more about Object Oriented programming within Python and also allowed me to learn more about Python's built-in libraries for file I/Oand how to use them to create a useful tool.
